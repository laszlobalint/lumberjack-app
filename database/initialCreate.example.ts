...
export class InitialCreate1584776858354 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      "CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `name` varchar(100) NOT NULL, UNIQUE INDEX `IDX_78a916df40e02a9deb1c4b75ed` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB",
      undefined
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      "ALTER TABLE `purchase` DROP FOREIGN KEY `FK_2195a69f2b102198a497036ec9e`",
      undefined
    );
    await queryRunner.query(
      "ALTER TABLE `purchase` DROP FOREIGN KEY `FK_9af3a556aa0f166dd771a1e6c46`",
      undefined
    );
    await queryRunner.query(
