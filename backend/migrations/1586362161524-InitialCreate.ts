...
export class InitialCreate1586362161524 implements MigrationInterface {
    name = 'InitialCreate1586362161524'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `purchase` (`id` int NOT NULL AUTO_INCREMENT, `amount` double NOT NULL, `price` double NOT NULL, `description` text NULL, `reduceStock` tinyint NOT NULL, `completed` tinyint NOT NULL, `deliveryDate` datetime NULL, `createdDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `customerId` int NULL, `productId` int NULL, `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
        await queryRunner.query("CREATE TABLE `customer` (`id` int NOT NULL AUTO_INCREMENT, `address` varchar(200) NOT NULL, `name` varchar(100) NULL, `phone` varchar(50) NULL, `companyName` varchar(100) NULL, `taxId` varchar(20) NULL, `nationalId` varchar(20) NULL, `checkingAccount` varchar(40) NULL, `description` text NULL, `createdDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
