...
export class InitialCreate1585740783596 implements MigrationInterface {
    name = 'InitialCreate1585740783596'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `purchase` (`id` int NOT NULL AUTO_INCREMENT, `amount` double NOT NULL, `price` double NOT NULL, `description` text NULL, `reduceStock` tinyint NOT NULL, `completed` tinyint NOT NULL, `deliveryDate` datetime NOT NULL, `createdDate` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `customerId` int NULL, `productId` int NULL, `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB", undefined);
